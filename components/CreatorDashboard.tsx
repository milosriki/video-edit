...
import { WandIcon, VideoIcon, ImageIcon, HeadphonesIcon, MessageSquareIcon, GridIcon, TagIcon, SparklesIcon, ScissorsIcon, VSLIcon } from './icons';
...
const ToolButton: React.FC<{
    ...
    <button
        onClick={onClick}
        className={`flex items-center w-full text-left p-3 rounded-lg transition-colors ${isActive ? 'bg-indigo-600 text-white' : 'text-gray-400 hover:bg-gray-700/50'
            }`}
