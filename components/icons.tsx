...
export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m15 4 5 2" /><path d="m17.7 7.7 3.5 3.5" /><path d="m14 10 3.9-3.9" /><path d="m14.3 14.3 3.5 3.5" /><path d="M9 21 21 9" /><path d="m2 10 2 1" /><path d="m5 10 1-1" /><path d="M2 14h2" /><path d="m5 14 1 1" /><path d="m2 18 2-1" />
  </svg>
);
...
export const EyeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="12" r="3"/><path d="M12 19c-4 0-7.333-2.333-10-7 2.667-4.667 6-7 10-7s7.333 2.333 10 7c-2.667 4.667-6 7-10 7z"/>
  </svg>
);
...
export const GoogleDriveIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M9 12h6" /><path d="M12 9v6" /><path d="M12 3a9 9 0 0 1 9 9 9 9 0 0 1-9 9 9 9 0 0 1-9-9 9 9 0 0 1 9-9z" />
  </svg>
);
...
export const VideoLibraryIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M7 2v20" /><path d="M17 2v20" /><rect x="2" y="6" width="20" height="12" rx="2" /><path d="M2 12h20" />
  </svg>
);
