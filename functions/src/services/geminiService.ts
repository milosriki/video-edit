...
export function getAvatars() {
    // Convert object map to array of {key, name}
    // FIX: Access the 'default' export of the JSON module
...
export async function analyzeVideoContent(allVideoData: any[]): Promise<import('../../../../types.js').CampaignStrategy> {
    ...
    const response = await ai.models.generateContent({
        ...
        config: {
            ...
            responseSchema: {
              // ... [Your full responseSchema for analysis] ...
              type: Type.OBJECT,
              properties: {
...
- Key Angles to Leverage: ${strategy.keyAngles.join(', ')}
...
// (Any other functions like generateStoryboard, generateImage would go here)